...
- Start WI-P6-005 (Transactions Redesign); refresh the transaction form and list to match the new visual system.
- Follow with WI-P6-006 (Projections Redesign).
...
**Phase 6:** Frontend Redesign (4/7 done)
